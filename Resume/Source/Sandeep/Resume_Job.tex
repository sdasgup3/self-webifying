...
\begin{body}
 ...
 \medskip
	...
	\begin{itemize} \itemsep -0pt
		\item  Worked in ``Google kernel performance'' team to augment the \href{https://git.kernel.org/pub/scm/linux/kernel/git/tip/tip.git/tree/tools/perf}{perf}
			...
			\end{itemize}
                ...
                allocation strategies or cache utilization.  Deployed prototype
                tools based on two different approaches: (1) Based on
                Allocation Based Profiling and (2) Based on Dwarf debug Info.
	...
	\begin{itemize} \itemsep -0pt
		\item  Worked in ``Google continuous profiling and efficiency'' team to augment the
			...
			performance changes (called ``havocs'' in this work) in CPU time.
                        \cmnt{Challenges are:
			\begin{itemize}
