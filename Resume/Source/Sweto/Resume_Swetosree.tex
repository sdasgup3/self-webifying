...
\newcommand{\cmnt}[1]{}
\newcommand{\cbox}[1]{\fbox{\colorbox{gray}{#1}}}
...
%\end{center}
  ...
  \begin{tabular}{lr}
\begin{tabular}{c}
\includegraphics[height=35mm,width=35mm]{mypic.png}
\end{tabular} & 
\begin{tabular}{c}
\\ \\  
\qquad\qquad\qquad\quad\quad\;\;\; {\Large Swetosree Sinha} \\ 
\begin{tabular}{l}
\qquad\qquad\qquad\qquad\qquad\qquad\qquad {{\texttt{Email}:\,\,\;\;\, swetosweet@gmail.com}} \\
\qquad\qquad\qquad\qquad\qquad\qquad\qquad {{\texttt{Phone}:\;\;\,   (+1) 2179049720}} \\
\end{tabular}  
\end{tabular} \\
&\\
\end{tabular}
...
\begin{body}
	\vspace{14pt}
        ...
        \cbox{\textbf{4.10 years of industrial experience in  {\emph{\href{https://www.accenture.com/in-en/accenture-services-private-limited}{Accenture Services Pvt. Ltd.}}}} \hfill \emph{August 2012 - May 2017}} \\
	\begin{itemize} \itemsep -0pt
...
(like debugger, profilers).
  ...
  \medskip
        \cbox{ \textbf{BTech in Electronics and Communication Engg. -- 85.5/100.00} \hfill \emph{August 2008 - July 2012}} \\
        from \emph{\href{http://www.aecwb.edu.in/index.php/}{Asansol Engineering College}}, (University: \href{http://www.wbut.ac.in}{West Bengal University of Technology}), West Bengal, India.\\
\end{body}
...
\begin{body}
	\vspace{14pt}
        \cbox{\textbf{Role:} Database Operation Analyst \hfill \textbf{Client:} \textbf{\emph{\href{https://www.globalpaymentsinc.com/en-us}{Global Payments Inc.}}} \hfill \emph{December 2014 - May 2017}}\\
	\vspace*{-4pt}
	\begin{itemize} \itemsep -0pt
...
from SME \& started working on RAC management.
	...
	\vspace*{2pt}
        ...
        \cbox{\textbf{Role:} SW/Application Tech Support Practitioner \hfill \textbf{Client:} \textbf{\emph{\href{http://www.libertyglobal.com}{Liberty Global}}} \hfill \emph{August 2012 - November 2014}}\\
	\vspace*{-4pt}
	\begin{itemize} \itemsep -0pt
...
West Bengal University of Technology                        & Bachelor of Technology                & 85.5\%                       & 7/2012        \\ \hline
