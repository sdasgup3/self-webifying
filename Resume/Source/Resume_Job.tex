	...
	\begin{itemize} \itemsep -0pt
          ...
          \item  Current Research 
            \begin{itemize} 
              ...
              \item To detect static analysis bugs using a mix of static program analysis
          and dynamic symbolic execution. Currently we are focusing on finding
          bugs in alias analysis.
            \end{itemize} 
        \end{itemize}
